...
module "eks" {
  ...
  eks_managed_node_groups = {
    managed-ng-01 = {
      ...
      tags = {
        Name = local.eks_node_group_name_01 # Custom EC2 instance name (Node Name in Node Group)
      }
    }
  }
...
module "eks_configmap" {
  ...
  aws_auth_roles = [
    ...
    {
      rolearn  = "arn:aws:iam::${var.aws_account_id}:role/warabej793-GitHubActionsRole"
...
#########################################
# Based on source:: https://github.com/aws-ia/terraform-aws-eks-blueprints-addons
